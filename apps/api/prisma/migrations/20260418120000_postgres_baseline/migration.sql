...
CREATE TABLE "OpsWorkspaceState" (
    ...
    CONSTRAINT "OpsWorkspaceState_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Task" (
    ...
    "parentTaskId" TEXT,
    "lastDeadlineReminderSentAt" TIMESTAMP(3),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "OpsWorkspaceState" ADD CONSTRAINT "OpsWorkspaceState_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
